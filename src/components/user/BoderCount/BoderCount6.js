...
export const BoderCount6 = ({ playerCount, random }) => {
    const className0 = cc([
    ...
    const className1 = cc([
        "border-l-4 border-r-4 border-gray-700 h-8",
        {
            "border-b-4": random.charAt(23) === "1",
        },
    ]);
    const className2 = cc([
        "border-l-4 border-r-4 border-gray-700 h-8",
        {
            "border-b-4": random.charAt(24) === "1",
        },
    ]);
    const className3 = cc([
        "border-l-4 border-r-4 border-gray-700 h-8",
        {
            "border-b-4": random.charAt(25) === "1",
        },
    ]);
    const className4 = cc([
        "border-l-4 border-r-4 border-gray-700 h-8",
        {
            "border-b-4": random.charAt(26) === "1",
        },
    ]);
