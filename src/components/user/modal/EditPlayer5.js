...
import { selectAmidakuji, putPlayer5 } from "src/redux/amidaSlice";
import { useSelector } from "react-redux";

export const EditPlayer5 = () => {
    ...
    const onSubmit = () => {
        const sendData = { ...Admidakuji, player5: value }
        putPlayer5(sendData)
        hideModal();
    }
        ...
        <>
            ...
            >
                <form className="px-12 pt-12" onSubmit={onSubmit} autoComplete="off" >
                    ...
                    <input name="player5" className={InputClassName} autoFocus value={value} onChange={(e) => setValue(e.target.value)} required maxLength="12" />
