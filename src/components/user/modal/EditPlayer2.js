...
export const EditPlayer2 = () => {
    ...
    const onSubmit = () => {
        const sendData = { ...Admidakuji, player2: value }
        putPlayer2(sendData)
        hideModal();
    }
        ...
        <>
            ...
            >
                <form className="px-12 pt-12" onSubmit={onSubmit} autoComplete="off" >
                    ...
                    <input name="player2" className={InputClassName} autoFocus value={value} onChange={(e) => setValue(e.target.value)} required maxLength="12" />
