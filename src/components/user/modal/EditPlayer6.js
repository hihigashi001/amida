...
import { selectAmidakuji, putPlayer6 } from "src/redux/amidaSlice";
import { useSelector } from "react-redux";

export const EditPlayer6 = () => {
    ...
    const onSubmit = () => {
        const sendData = { ...Admidakuji, player6: value }
        putPlayer6(sendData)
        hideModal();
    }
        ...
        <>
            ...
            >
                <form className="px-12 pt-12" onSubmit={onSubmit} autoComplete="off" >
                    ...
                    <input name="player6" className={InputClassName} autoFocus value={value} onChange={(e) => setValue(e.target.value)} required maxLength="12" />
    ...
    return <p className="bg-primary hover:bg-secondary text-white cursor-pointer writing-mode-vertical mx-auto py-6 px-1 border border-gray-200 leading-none m-0 whitespace-nowrap" onClick={showModal}>選択する</p>
}
