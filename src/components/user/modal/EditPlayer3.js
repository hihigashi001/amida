...
import { selectAmidakuji, putPlayer3 } from "src/redux/amidaSlice";
import { useSelector } from "react-redux";

export const EditPlayer3 = () => {
    ...
    const onSubmit = () => {
        const sendData = { ...Admidakuji, player3: value }
        putPlayer3(sendData)
        hideModal();
    }
        ...
        <>
            ...
            >
                <form className="px-12 pt-12" onSubmit={onSubmit} autoComplete="off" >
                    ...
                    <input name="player3" className={InputClassName} autoFocus value={value} onChange={(e) => setValue(e.target.value)} required maxLength="12" />
