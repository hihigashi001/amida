...
import { selectAmidakuji, putPlayer10 } from "src/redux/amidaSlice";
...
export const EditPlayer10 = () => {
    ...
    const onSubmit = () => {
        const sendData = { ...Admidakuji, player10: value }
        putPlayer10(sendData)
        hideModal();
    }
        ...
        <>
            ...
            >
                <form className="px-12 pt-12" onSubmit={onSubmit} autoComplete="off" >
                    ...
                    <input name="player10" className={InputClassName} autoFocus value={value} onChange={(e) => setValue(e.target.value)} required maxLength="12" />
