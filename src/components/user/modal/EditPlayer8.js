...
import { selectAmidakuji, putPlayer8 } from "src/redux/amidaSlice";
...
export const EditPlayer8 = () => {
    ...
    const onSubmit = () => {
        const sendData = { ...Admidakuji, player8: value }
        putPlayer8(sendData)
        hideModal();
    }
        ...
        <>
            ...
            >
                <form className="px-12 pt-12" onSubmit={onSubmit} autoComplete="off" >
                    ...
                    <input name="player8" className={InputClassName} autoFocus value={value} onChange={(e) => setValue(e.target.value)} required maxLength="12" />
