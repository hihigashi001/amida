...
import { selectAmidakuji, putPlayer4 } from "src/redux/amidaSlice";
...
export const EditPlayer4 = () => {
    ...
    const onSubmit = () => {
        const sendData = { ...Admidakuji, player4: value }
        putPlayer4(sendData)
        hideModal();
    }
        ...
        <>
            ...
            >
                <form className="px-12 pt-12" onSubmit={onSubmit} autoComplete="off" >
                    ...
                    <input name="player4" className={InputClassName} autoFocus value={value} onChange={(e) => setValue(e.target.value)} required maxLength="12" />
