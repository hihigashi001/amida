...
import { selectAmidakuji, putPlayer7 } from "src/redux/amidaSlice";
import { useSelector } from "react-redux";

export const EditPlayer7 = () => {
    ...
    const onSubmit = () => {
        const sendData = { ...Admidakuji, player7: value }
        putPlayer7(sendData)
        hideModal();
    }
        ...
        <>
            ...
            >
                <form className="px-12 pt-12" onSubmit={onSubmit} autoComplete="off" >
                    ...
                    <input name="player7" className={InputClassName} autoFocus value={value} onChange={(e) => setValue(e.target.value)} required maxLength="12" />
