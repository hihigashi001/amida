...
import { selectAmidakuji, putPlayer1 } from "src/redux/amidaSlice";
...
export const EditPlayer1 = () => {
    ...
    const onSubmit = () => {
        const sendData = { ...Admidakuji, player1: value }
        putPlayer1(sendData)
        hideModal();
    }
        ...
        <>
            ...
            >
                <form className="px-12 pt-12" onSubmit={onSubmit} autoComplete="off" >
                    ...
                    <input name="player1" className={InputClassName} autoFocus value={value} onChange={(e) => setValue(e.target.value)} required maxLength="12" />
